...
# Aram IDE GUI_Version_7.3 (Adds keywords for file handling, switch cases, list/tuple/set and enabling scrolling on left pane and minimal autocomplete (barackets(),{},[] ,cotation'',""))
# Contains full removal of Autocomplete
