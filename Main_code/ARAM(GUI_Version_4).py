...
#Aram IDE GUI_Version_4 (Supports All Highliting, Input and Error Handling(Here exit function is locked mannually) with corrected output order)
        ...
        def check_queue():
            try:
                while True:
                    ...
                    tag = "error_msg" if "பிழை" in message or "Error" in message else None
