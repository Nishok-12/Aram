...
# Aram IDE GUI_Version_7.2 (Adds keywords for file handling, switch cases, list/tuple/set and enabling scrolling on left pane and minimal autocomplete (barackets(),{},[] ,cotation'',""))
...
class ARAMWindow:
    ...
    def _auto_complete_brackets(self, event):
        """
        Handles auto-completion for brackets and quotes,
        while also triggering Tamil replacement when '(' follows a keyword.
        """
        char = event.char
        completion_map = {
            '(': ')',
